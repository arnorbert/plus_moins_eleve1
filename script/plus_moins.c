...
int main()
{
	...
	printf("Veuillez inserer le nombre de tour a jouer: ");
	scanf("%d",&i);
	do
	{
		valeur_a_trouver = rand() % 100 + 1;
		printf("\nJoueur 1, veillez inserer un nombre de coup maximum a jouer par le Joueur 2(doit etre superieur a 10): ");
		scanf("%d",&coup);
		do
		{
	...
	printf("\nLe score du Joueur 1 est: %d",score_joueur1);
	printf("\nLe score du Joueur 2 est: %d",score_joueur2);
